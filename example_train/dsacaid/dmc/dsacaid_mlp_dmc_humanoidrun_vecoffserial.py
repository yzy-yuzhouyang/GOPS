...
if __name__ == "__main__":
    ...
    parser.add_argument("--lambda_lower", type=float, default=1e-4, help="Lower confidence bound coefficient")
    ...
    parser.add_argument("--lambda_upper", type=float, default=1e-4, help="Upper confidence bound coefficient")
