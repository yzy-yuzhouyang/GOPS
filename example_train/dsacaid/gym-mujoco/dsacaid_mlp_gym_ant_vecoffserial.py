...
if __name__ == "__main__":
    ...
    parser.add_argument("--beta", type=float, default=0.03, help="Initial aleatoric pessimism coefficient")
    parser.add_argument("--beta_annealing_rate", type=float, default=1.5e-4, help="Annealing rate for beta")
    ...
    parser.add_argument("--use_homogeneous_sigma_step_ratio", type=bool, default=False, help="Use homogeneous modulation ratio for sigma")
