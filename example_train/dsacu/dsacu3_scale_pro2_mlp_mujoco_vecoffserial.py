...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="DSACU3SCALEPro2", help="RL algorithm")
    parser.add_argument("--enable_cuda", default=True, help="Enable CUDA")
    parser.add_argument("--seed", default=32345, help="Global seed")
    ...
    parser.add_argument("--sampler_name", type=str, default="off_pro_sampler", help="Options: on_sampler/off_sampler")
