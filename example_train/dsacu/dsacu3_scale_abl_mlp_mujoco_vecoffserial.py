...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="DSACU3SCALEAbl", help="RL algorithm")
    parser.add_argument("--enable_cuda", default=True, help="Enable CUDA")
    parser.add_argument("--seed", default=2345, help="Global seed")
    ...
    parser.add_argument("--num_q", default=10, help="num_q")
    ################################################
