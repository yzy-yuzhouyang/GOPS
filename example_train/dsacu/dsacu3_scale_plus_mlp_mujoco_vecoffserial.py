...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="DSACU3SCALEPlus", help="RL algorithm")
    ...
    parser.add_argument("--beta_learning_rate", type=float, default=1.5e-4) # SGD: 1.5e-6
    # special parameter
