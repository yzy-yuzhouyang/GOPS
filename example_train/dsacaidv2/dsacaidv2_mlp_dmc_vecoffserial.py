...
if __name__ == "__main__":
    ...
    parser.add_argument("--beta_annealing_rate", type=float, default=0, help="Annealing rate for beta")
    ...
    parser.add_argument(
        ...
        help="Options: RegularizedActionValueDistri/ActionValueDistri",
    )
    ...
    # 2.2 Parameters of evidence approximate function
    parser.add_argument(
        "--evidence_func_name",
        type=str,
        default="EvidenceNetwork",
        help="Options: RegularizedActionValueDistri/ActionValueDistri",
    )
    parser.add_argument("--evidence_func_type", type=str, default="MLP", help="Options: MLP/CNN/CNN_SHARED/RNN/POLY/GAUSS")
    evidence_func_type = parser.parse_known_args()[0].evidence_func_type
    parser.add_argument("--evidence_hidden_sizes", type=list, default=[256,256,256])
    parser.add_argument(
        "--evidence_hidden_activation", type=str, default="relu", help="Options: relu/gelu/elu/selu/sigmoid/tanh"
    )
    parser.add_argument("--evidence_output_activation", type=str, default="linear", help="Options: linear/tanh")
    ...
    parser.add_argument("--evidence_learning_rate", type=float, default=0.0003)
