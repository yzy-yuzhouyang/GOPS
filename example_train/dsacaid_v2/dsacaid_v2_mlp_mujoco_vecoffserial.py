...
if __name__ == "__main__":
    ...
    parser.add_argument("--exp_tag", type=str, default="_clip_n_alpha_0.1", help="Experiment tag for logging and identification")
    # =========================================================================
    ...
    parser.add_argument("--beta_ratio", type=float, default=1.0, help="")
    parser.add_argument("--clip_thd", type=float, default=1.0, help="")
    ...
    parser.add_argument("--evidence_guard_coef", type=float, default=0.2, help="Evidence count guard coefficient")
    ...
    parser.add_argument("--asymmetry_ratio", type=float, default=0.0, help="")
    ...
    parser.add_argument(
        "--value_func_name",
        type=str,
        default="ActionValueDoubleDistri",
    ...
    parser.add_argument("--evaluator_name", type=str, default="evaluator_dsacaidv2")
    ...
    ################################################
    # 7. Data savings
    parser.add_argument("--save_folder", type=str, default="/NAS/62/yuzhouyang/results/AIDv2")
