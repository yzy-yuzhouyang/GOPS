...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ini_network_dir",
        type=str,
        default="/home/yuzhouyang/code/GOPS/results/gym_ant/DSACT-1234_250908-210238/apprfunc/apprfunc_1467500_opt.pkl"
    )
    ...
    parser.add_argument("--evaluator_name", type=str, default="evaluator_getsa")
