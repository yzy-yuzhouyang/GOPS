...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="DSACTAutoMapExp", help="RL algorithm")
    ...
    parser.add_argument("--beta_inside", default=False, help="beta_inside")
    ################################################
    ...
    parser.add_argument("--beta_learning_rate", type=float, default=3e-4) # SGD: 1.5e-6
    # special parameter
