...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="DSACTClosedMinus", help="RL algorithm")
    ...
    parser.add_argument("--oe_std_factor", default=1.0, help="oe_std_factor")
    ################################################
    ...
    parser.add_argument(
        "--trainer",
        type=str,
        default="off_serial_closed_trainer",
