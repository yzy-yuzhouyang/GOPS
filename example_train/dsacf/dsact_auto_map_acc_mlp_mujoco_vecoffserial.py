...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="DSACTAutoMap", help="RL algorithm")
    ...
    parser.add_argument("--value_learning_rate", type=float, default=0.0002)
    parser.add_argument("--policy_learning_rate", type=float, default=0.0002)
    parser.add_argument("--alpha_learning_rate", type=float, default=0.0005)
    parser.add_argument("--beta_learning_rate", type=float, default=6e-4) # SGD: 1.5e-6
    # special parameter
    ...
    parser.add_argument(
        "--trainer",
        type=str,
        default="off_serial_DSACF_trainer",
