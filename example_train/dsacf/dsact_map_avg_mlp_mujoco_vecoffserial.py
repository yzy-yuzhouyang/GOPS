...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="DSACTMap", help="RL algorithm")
    parser.add_argument("--enable_cuda", default=True, help="Enable CUDA")
    parser.add_argument("--seed", default=1234, help="Global seed")
    parser.add_argument("--stop", default=0.3, help="stop")
    parser.add_argument("--beta_init", default=0.1, help="beta_init")
    parser.add_argument("--use_avg", default=True, help="use_avg")
    ################################################
