...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="DSACUPRO", help="RL algorithm")
    parser.add_argument("--enable_cuda", default=True, help="Enable CUDA")
    parser.add_argument("--seed", default=1234, help="Global seed")
    parser.add_argument("--stop", default=0.7, help="stop")
    parser.add_argument("--beta", default=0.01, help="beta")
    ...
    parser.add_argument("--beta_learning_rate", type=float, default=6e-5) # SGD: 1.5e-6
    # special parameter
