...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="DSACTAbSort", help="RL algorithm")
    parser.add_argument("--enable_cuda", default=True, help="Enable CUDA")
    parser.add_argument("--seed", default=1234, help="Global seed")
    parser.add_argument("--num_samples", default=10, help="Number of samples")
    parser.add_argument("--enable_track", default=True, help="Enable track")
    parser.add_argument(
        "--track_file", 
        default="/home/yuzhouyang/code/GOPS/results/gym_ant/DSACT-1234_for_track/evaluator/track/iter2500_ep0.npy", 
        help="Track File"
    )
    ################################################
