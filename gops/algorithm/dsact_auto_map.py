...
class DSACTAutoMap(AlgorithmBase):
    ...
    def _compute_gradient(
        ...
        if update_beta:
            ...
            mean_std = (self.mean_std1 + self.mean_std2) / 2
    ...
    def _compute_loss_q(self, data: DataDict):
        ...
        with torch.no_grad():
            ...
            q_next = torch.min(q1_next - self._get_beta() * q1_std_next, q2_next - self._get_beta() * q2_std_next)
            if self.near_end:
